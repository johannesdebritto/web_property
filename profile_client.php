                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                            ...
                                            <td><a  class="btn btn-success"href="edit_data_client.php?id=<?php echo $x['kode_client']; ?>">Edit </a></td>
                                            <td><a class="btn btn-warning" href="hapus_data_client.php?id=<?php echo $x['kode_client']; ?>">Hapus</a></td>
