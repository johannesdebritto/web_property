                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Menampilkan Tipe Rumah</h3>
                                </div>
                                <!--/.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn btn-success" href="edit_data_tipe_rumah.php?id=<?php echo $x['kode_rumah']; ?>">Edit</a></td>
                                                <td><a class="btn btn-warning" href="hapus_data_tipe_rumah.php?id=<?php echo $x['kode_rumah']; ?>">Hapus</a></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
                                        </table>
                                        <a class="btn btn-primary" href="tambah_tipe_rumah.php" role="button">Tambah</a>
                                        </tbody>
