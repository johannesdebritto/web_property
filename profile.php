                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                            ...
                                            <td><a class="btn btn-success" href="edit_data_admin.php?id=<?php echo $x['id']; ?>">Edit Foto Aja</a></td>
                                            <td><a class="btn btn-warning" href="hapus_data_admin.php?id=<?php echo $x['id']; ?>">Hapus</a></td>
