                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $jumlah_user = $db->hitung_jumlah_data_client(); // Gantilah dengan fungsi yang sesuai untuk menghitung jumlah data
                                                echo $jumlah_user;
                                                ?>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $jumlah_property = $db->hitung_jumlah_data_property(); // Gantilah dengan fungsi yang sesuai untuk menghitung jumlah data
                                                echo $jumlah_property;
                                                ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $jumlah_proyek = $db->hitung_jumlah_proyek(); // Gantilah dengan fungsi yang sesuai untuk menghitung jumlah data
                                                echo $jumlah_proyek;
                                                ?>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $jumlah_ulasan = $db->hitung_jumlah_ulasan(); // Gantilah dengan fungsi yang sesuai untuk menghitung jumlah data
                                                echo $jumlah_ulasan;
                                                ?>
                                            </div>
                                        </div>
