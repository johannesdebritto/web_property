                ...
                <!-- End of Topbar -->
                        ...
                        <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                            ...
                                            <td><a href="edit_data_admin.php?id=<?php echo $x['id']; ?>">Edit Foto Aja</a></td>
                         ...
                         <div class="container-fluid">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                            $no = 1;
                                            foreach ($db->tampil_data_client() as $x) {
                                            ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                                                <td><?php echo $x['kode_client']; ?></td>
                                            ...
                                            <td><a href="edit_data_client.php?id=<?php echo $x['kode_client']; ?>">Edit </a></td>
                                            <td><a href="hapus_data_client.php?id=<?php echo $x['kode_client']; ?>">Hapus</a></td>
                            ...
                            <a class="btn btn-primary" href="tambah_data_client.php" role="button">Tambah Client</a>
