                                        ...
                                        <td>
                                            <?php
                                                ...
                                                if ($status_proyek == '1') {
                                                    ...
                                                    $tanggal_selesai1 = new DateTime($x['tanggal_selesai']);
                                                    
                                                    if ($tanggal_hari_ini < $tanggal_selesai1) {
                                                        echo "Proyek Belum Selesai";
                                                    } else {
                                                        $diff = $tanggal_hari_ini->diff($tanggal_selesai1);
                                                        echo "Proyek Belum Selesai";
                                                    }
                                            ...
                                            <td><a class="btn btn-warning" href="hapus_data_proyek.php?id=<?php echo $x['kode_rumah']; ?>">Hapus</a></td>
