            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                   <!-- Begin Page Content -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                    $no = 1;
                                    foreach ($db->tampil_bank() as $x) {
                                    ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><?php echo $x['kode_bank']; ?></td>
                                    ...
                                    <td><a class="btn btn-success" href="hapus_data_bank.php?id=<?php echo $x['kode_bank']; ?>">Hapus</a></td>
                    ...
                    <!--/.card -->
                    <a class="btn btn-primary" href="tambah_data_bank.php" role="button">Tambah Daftar Bank</a>
